...
class ModelUserSatatistics {
  ...
  getFormattedData() {
    ...
    return [
      {
        icon: icons.calorieCount,
        value: `${this.userData.keyData.calorieCount}kCal`,
        label: "Calories",
      },
      {
        icon: icons.proteinCount,
        value: `${this.userData.keyData.proteinCount}g`,
        label: "Proteines",
      },
      {
        icon: icons.carbohydrateCount,
        value: `${this.userData.keyData.carbohydrateCount}g`,
        label: "Glucides",
      },
      {
        icon: icons.lipidCount,
        value: `${this.userData.keyData.lipidCount}g`,
        label: "Lipides",
      },
    ];
  }
