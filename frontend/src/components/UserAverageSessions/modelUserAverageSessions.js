class ModelUserAverageSessions {
  constructor(sessions) {
    ...
    this.beforeMonday =
      (sessions[0].sessionLength + sessions[1].sessionLength) / 2; // Moyenne de Lundi et Mardi
    this.afterSunday =
      (sessions[5].sessionLength + sessions[6].sessionLength) / 2; // Moyenne de Samedi et Dimanche
